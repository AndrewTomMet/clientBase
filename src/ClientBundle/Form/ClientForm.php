...
class ClientForm extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('created_at', DateType::class, ['widget' => 'text', 'required' => false, 'format' => 'dd-MM-yyyy',
            'disabled' => true, ])
            ->add('firstname', TextType::class)
            ->add('surname', TextType::class, ['required' => false, ])
            ->add('birthday', BirthdayType::class, ['format' => 'dd-MM-yyyy', 'placeholder' => 'dd-mm-yyyy', 'widget' => 'text',
            'required' => false, ])
